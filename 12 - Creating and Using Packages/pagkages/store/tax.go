...
// var categoryMaxPrices = map[string]float64{"WaterSport": 250 + (defaultTaxRate * 0.2), "Soccer": 150 + (150 * defaultTaxRate), "Chess": 50 + (50 * defaultTaxRate)}
// thay bang tranh lpa va de vao tri
